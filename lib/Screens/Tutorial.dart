         ...
         body: Container(
          ...
          fit: BoxFit.cover,
           ...
           children: [
              ...
              value.isClick==false? TutorialText(TITLE, DARK_CLR, FontWeight.bold, 25):TutorialText(TITLE, DARK_CLR, FontWeight.bold, 25),
                    SizedBox(
                      height: h*0.010,
                    ),
    
           value.isClick==false? TutorialText(TUTORIAL_SUB_TITLE, DARK_CLR, FontWeight.normal, 18):
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: value.isClick==false? GREEN_CLR:WHITE_CLR
                              ),
                            ),
                            ...
                            SizedBox(
                             ...
                             Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),
                                border: Border.all(color: GREEN_CLR),
                                color:value.isClick==true?GREEN_CLR:WHITE_CLR
                              ),
                            ),
                          ],
                        ),
                      ...
                      Consumer<ProviderTutorial>(
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                              ...
                              child: styleText( value.isClick==false?NEXT:GET_STARTED
