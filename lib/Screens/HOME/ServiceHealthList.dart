                                           ...
                                           Column(
                                            children: [
                                              GestureDetector(onTap: (){
                                                ...
                                                color: value.currenindex==index?GREEN_CLR:WHITE_CLR,
                                                ...
                                                child: Image.asset(SERVICES_ICON,color: value.currenindex==index?WHITE_CLR:GRAY_CLR,),
                                              ...
                                              styleText(value.data.elementAt(index), GRAY_CLR, FontWeight.bold, 13)
                                            ],
                                          );
                                          }
                                        );
